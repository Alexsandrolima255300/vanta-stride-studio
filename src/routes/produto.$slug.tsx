      ...
      <div className="mt-8 grid gap-12 lg:grid-cols-2">
        ...
        >
          ...
          <p className="mt-1 text-sm text-muted-foreground">
            ou 10x de {brl(product.price / 10)} sem juros
          </p>
          ...
          <div className="mt-8 flex flex-wrap gap-3">
            <Button
              ...
              className="rounded-sm px-10 text-xs uppercase tracking-[0.25em]"
              onClick={() =>
                size
                  ? toast.success(`${product.name} · tam ${size} adicionado à sacola`)
          ...
          <ul className="mt-9 space-y-2 text-sm text-muted-foreground">
            <li className="flex items-center gap-2">
              <Truck className="size-4 text-accent" /> Frete grátis acima de R$ 399
            </li>
            <li className="flex items-center gap-2">
              <Check className="size-4 text-accent" /> Amortecimento{" "}
              {"★".repeat(product.amortecimento)}
            </li>
            <li className="flex items-center gap-2">
